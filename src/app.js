...
const allowedOrigins = [
  ...
  'http://localhost:3000',
  'https://oicethiopiahrms.vercel.app'
].filter(Boolean);
...
(async () => {
  // Attempt DB connection in background, don't block server startup
  sequelize.authenticate()
    .then(() => console.log('✅ Database connected and verified'))
    .catch(err => {
      console.log('⚠️  Database is currently unreachable (MOCK MODE ACTIVE)');
